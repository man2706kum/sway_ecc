...
contract FflonkVerifier {
    uint32 constant n     = 2048; // Domain size
    ...
    uint256 constant wr   = 2369491970759584452636710321304902931967460429047736379260414030272612059905;
    // Omega_3, Omega_3^2
    ...
    uint256 constant C0x  = 21393903866468016519019588271676522432117204152777221993192971410850304762139;
    uint256 constant C0y  = 15569685261325594216959528560965491424257952338371238361950304987919092550065;
